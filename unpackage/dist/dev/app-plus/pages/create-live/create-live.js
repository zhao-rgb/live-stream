              ...
              _c(
                ...
                [
                  _c(
                    "u-text",
                    {
                      staticClass: ["iconfont", "text-white", "mt-5"],
                      on: { click: _vm.back }
                    },
                    [_vm._v("")]
                  )
              ...
              _c(
                ...
                [
                  _c(
                    ...
                    [
                      _c("u-image", {
                        ...
                        staticStyle: { height: "120rpx", width: "120rpx" },
                        attrs: { src: _vm.form.cover || "/static/2.jpg" }
                      }),
                      _c(
                        "u-text",
                        {
                  ...
                  _c(
                    ...
                    [
                      _c("u-input", {
                        staticClass: ["mb-2", "text-light", "mt-2"],
                        attrs: {
                          type: "text",
                          placeholder: "请输入直播标题",
...
"use strict";
eval("/* WEBPACK VAR INJECTION */(function(__f__) {Object.defineProperty(exports, \"__esModule\", { value: true });exports.default = void 0;\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\nvar _uniPopup = _interopRequireDefault(__webpack_require__(/*! ../../components/uni-ui/uni-popup/uni-popup.vue */ 17));\nvar _request = _interopRequireDefault(__webpack_require__(/*! @/common/request.js */ 46));\nvar _config = _interopRequireDefault(__webpack_require__(/*! @/common/config.js */ 45));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };} //\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\nvar _default = { components: { uniPopup: _uniPopup.default }, data: function data() {return { // url: '', // 直播服务器地址，暂时为空\n      mode: 'SD', // 标清模式\n      enableCamera: true, // 是否启用摄像头\n      position: 'back', // 默认摄像头\n      beauty: 0, // 美颜程度\n      whiteness: 0, //美白度\n      windowHeight: 0, // 窗体高度\n      context: null, //上下文\n      statusBarHeight: 0, modeList: [{ type: 'SD', desc: '标清' }, { type: 'HD', desc: '高清' }, { type: 'FHD', desc: '超清' }], popupType: 'mode', showBars: true, form: { title: '', cover: '' } };}, // 监听页面加载，其参数为上个页面传递的数据，参数类型为Object（用于页面传参）\n  onLoad: function onLoad() {var res = uni.getSystemInfoSync();this.windowHeight = res.windowHeight;this.statusBarHeight = res.statusBarHeight;}, // 监听页面初次渲染完成，如果渲染速度快，会在页面进入动画完成前触发\n  onReady: function onReady() {this.context = uni.createLivePusherContext('livePusher', this);this.startPreview();}, computed: { popupTitle: function popupTitle() {var o = { mode: '画质', beauty: '美颜', whiteness: '美白' };return o[this.popupType];}, src: function src() {return \"rtmp://121.5.129.115:1935/live/\".concat(this.key);} }, methods: { chooseCover: function chooseCover() {var _this = this;uni.chooseImage({ count: 1, success: function success(res) {_request.default.upload('/upload', { filePath: res.tempFilePaths[0] }, function (p) {__f__(\"log\", p, \" at pages/create-live/create-live.nvue:212\");}).then(function (res) {_this.form.cover = _config.default.imgUrl + res.url;});} });}, back: function back() {uni.navigateBack({ delta: 1 });}, openLiveRoom: function openLiveRoom() {var _this2 = this;_request.default.post('/live/create', this.form, { token: true }).then(function (res) {var options = { mode: _this2.mode, position: _this2.position, beauty: _this2.beauty, whiteness: _this2.whiteness };_this2.key = res.data.key;__f__(\"log\", _this2.key, \" at pages/create-live/create-live.nvue:237\");_this2.context.start({ success: function success(a) {__f__(\"log\", 'livePusher.start:' + JSON.stringify(a), \" at pages/create-live/create-live.nvue:241\");} });uni.navigateTo({ url: \"../live-room/live-room?options=\".concat(JSON.stringify(options), \"&data=\").concat(encodeURIComponent(JSON.stringify(res))) });});}, handleSliderChange: function handleSliderChange(e) {this[this.popupType] = e.detail.value;}, // 画质选择\n    chooseMode: function chooseMode(item) {this.mode = item.type;uni.showToast({ title: '画质切换为' + item.desc, icon: 'none' });this.$refs.popup.close();}, openPopup: function openPopup(type) {this.popupType = type;this.$refs.popup.open();}, // \t切换摄像头\n    switchCamera: function switchCamera() {var _this3 = this;this.context.switchCamera({ success: function success(e) {_this3.position = _this3.position === 'back' ? 'front' : 'back';} });}, // 开启预览模式\n    startPreview: function startPreview() {this.context.startPreview({ success: function success(e) {__f__(\"log\", e, \" at pages/create-live/create-live.nvue:283\");\n        } });\n\n    },\n    // 直播状态的变化\n    statechange: function statechange(e) {\n      __f__(\"log\", e, \" at pages/create-live/create-live.nvue:289\");\n    },\n    // 直播网络的变化\n    netstatus: function netstatus(e) {\n      __f__(\"log\", e, \" at pages/create-live/create-live.nvue:293\");\n    },\n    // 直播出错\n    error: function error(e) {\n      __f__(\"log\", e, \" at pages/create-live/create-live.nvue:297\");\n    } } };exports.default = _default;\n/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(/*! ./node_modules/@dcloudio/vue-cli-plugin-uni/lib/format-log.js */ 9)[\"default\"]))//# sourceURL=[module]\n//# sourceMappingURL=data:application/json;charset=utf-8;base64,\n//# sourceURL=webpack-internal:///55\n");
